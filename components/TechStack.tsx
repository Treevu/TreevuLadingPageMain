...
import { Eye, Brain, Bot, Sparkles, ArrowRight, Target, Receipt, TrendingUp } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="relative z-10 bg-treevu-surface border border-treevu-active p-8 rounded-3xl hover:border-segment-empresa transition-all duration-300 hover:-translate-y-2 group">
            ...
            <p className="text-segment-empresa text-center text-xs font-bold uppercase tracking-widest mb-8">TREEVÜ COGNITIVE CORE™</p>
            
            <div className="h-px w-full bg-treevu-active mb-6"></div>

             <ul className="space-y-4">
              <li className="flex items-start">
                <TrendingUp className="w-5 h-5 mr-3 text-segment-empresa flex-shrink-0" />
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-300 text-sm">Predicción de fuga</span>
              </li>
            </ul>
          </div>
