...
const RoiCalculator: React.FC = () => {
  ...
  const TREEVU_COST_PER_USER = 7; // $7 USD
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Descubre cuánto le cuesta realmente la rotación a tu empresa y cuánto podrías ahorrar implementando Treevü.
          </p>
        </div>
                        ...
                        {step === 'TEASER' ? (
                            ...
                            <div className="relative z-10 flex flex-col items-center text-center py-6">
                                ...
                                <p className="text-gray-400 mb-8 max-w-md">
                                    Tu ROI NETO es la clave. Revela cuánto ganarás tras deducir el costo del Plan Launch de Treevü.
                                </p>
                            ...
                            <div className="animate-fade-in-up relative z-10">
                                ...
                                <div className="grid grid-cols-2 gap-6 mb-8">
                                    <div className="p-4 rounded-xl bg-treevu-base border border-treevu-active">
                                        ...
                                        <p className="text-[10px] text-gray-500 mt-1">Plan Launch ($7/user)</p>
                                    </div>
