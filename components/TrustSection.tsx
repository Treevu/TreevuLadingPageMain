          ...
          <div className="grid md:grid-cols-5 gap-12 items-center">
            <AnimateOnScroll className="md:col-span-3 text-center md:text-left">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 mb-6 leading-tight">
                Creado por un equipo
                <br /> obsesionado con los datos.
              </h2>
              <p className="text-lg text-slate-600 max-w-2xl">
                Treevü está formada por un equipo con décadas de experiencia en{" "}
                <span className="font-semibold text-slate-800">
                  estrategia de negocios, finanzas corporativas y ciencia de
                  datos.
                </span>{" "}
                Nuestra misión: que las personas vivan mejor y las empresas
            ...
            >
              <div className="bg-teal-500 text-white p-8 rounded-xl shadow-2xl shadow-teal-500/30 transform md:rotate-3">
                ...
                <p className="text-2xl font-bold mt-2">
                  Somos el radar predictivo del bienestar financiero de tu
                  organización.
                </p>
              </div>
            </AnimateOnScroll>
